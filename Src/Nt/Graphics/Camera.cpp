...
namespace Nt {
	...
	void Camera::Render([[maybe_unused]] Renderer* pRenderer) const
	{
	}
	void Camera::Render([[maybe_unused]] Renderer* pRenderer, [[maybe_unused]] const uInt& offset, [[maybe_unused]] const uInt& verticesCount) const
	{
	}
