...
namespace Nt {
	...
	private:
		Bool m_IsPressedKeyArray[256] = { };
		Bool m_IsPressedKeyPrevStateArray[256] = { };
	};
	...
	public:
		...
		NT_API Bool IsButtonPressed(const Key& button, const Bool& once) noexcept;

		NT_API static Bool MoveCursorToCenter() noexcept;
		NT_API static Int2D GetCursorPosition() noexcept;
		NT_API static void SetCursorPosition(const Int2D& position) noexcept;

	private:
		Bool m_IsPressedButtonArray[6] = { };
		Bool m_IsPressedButtonPrevStateArray[6] = { };
	};
