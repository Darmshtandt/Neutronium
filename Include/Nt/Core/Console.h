...
namespace Nt {
	enum class CodePageID : unsigned {
		...
		EUC_JP_JIS = 20932,					// Japanese (JIS 0208-1990 and 0212-1990)
	...
	class Console {
	public:
		NT_API static void Show() noexcept;
		NT_API static void Hide() noexcept;

		NT_API static void Pause() noexcept;
		NT_API static void Clear() noexcept;

		NT_API static Int SetInputCodePage(const CodePageID& ID) noexcept;
		NT_API static Int SetOutputCodePage(const CodePageID& ID) noexcept;
		NT_API static Int2D SetIOCodePage(const CodePageID& ID) noexcept;
	};
}